...
int main()
{
    ...
    float sen_total, suite_total, doble_total;
    sen_total = suite_total = doble_total = 0.0;
    int tipo_habitacion, noches, num_habitaciones, num_huespedes, num_personas, subtotal, total;
    tipo_habitacion = noches = num_habitaciones = num_huespedes = num_personas = subtotal = total = 0;
